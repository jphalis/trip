# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-01-31 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('charge_id', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
                ('currency', models.CharField(default='usd', max_length=10)),
                ('amount', models.PositiveIntegerField(help_text='A positive integer in cents (or 0 for a free plan) representing how much to charge (on a recurring basis).', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cu_id', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
                ('account_balance', models.PositiveIntegerField(help_text='A positive integer in cents (or 0 for a free plan) representing how much to charge (on a recurring basis).')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('invoice_id', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('plan_id', models.SlugField(blank=True, max_length=255, null=True, unique=True)),
                ('name', models.CharField(help_text='Name of the plan, to be displayed on invoices and in the web interface.', max_length=150)),
                ('description', models.TextField(blank=True)),
                ('amount', models.PositiveIntegerField(help_text='A positive integer in cents (or 0 for a free plan) representing how much to charge (on a recurring basis).')),
